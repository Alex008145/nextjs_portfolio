    ...
    <div className="w-full">
      ...
      <div className="w-screen h-[30vh] lg:h-[40vh] relative  z-60">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10">
          <h2 className="py-2">React Eats</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="py-4">
            Этот проект написан на React JS. Сайт доставки еды из ресторана.
            Доступные для заказа блюда хранятся в базе данных Firebase.
          </p>
          <a href="https://react-eats-two.vercel.app/" target="_blank">
          ...
          <a href="https://github.com/Alex008145/react-eats" target="_blank">
