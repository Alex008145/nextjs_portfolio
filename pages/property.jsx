      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="py-4">
            ...
            использует базу данных MongoDB. <br /> Promptopia — это инструмент с
            открытым исходным кодом для сохранения запросов к ИИ,
            предназначенный для современного мира. Он предоставляет
            пользователям возможность открывать, создавать и делиться
            творческими подсказками, чтобы вдохновлять их на написание текстов,
            сессии мозгового штурма и творческие проекты. Присутствует
